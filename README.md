...
| Property | Value |
|----------|-------|
| **Registry** | [hub.docker.com/r/ragas111/insureiq-backend](https://hub.docker.com/repository/docker/ragas111/insureiq-backend/general) |
...
flowchart LR
    ...
    C -->|docker push| D["Docker Hub\nragas111/insureiq-backend"]
    D -->|docker pull| E["☁️ Render\nContainer Host"]
    E -->|port 8000| F["🌐 Live API\ninsureiq.onrender.com"]
```
